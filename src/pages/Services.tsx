...
export default function Services({ onNavigate }: ServicesProps) {
  ...
  const servicesList = [
    ...
    },
    {
      ...
      description: 'Strategic social media campaigns that build communities and drive engagement. We manage <b/> your presence across platforms, create compelling content, and grow your audience organically.',
    },
    {
