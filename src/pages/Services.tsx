...
export default function Services({ onNavigate }: ServicesProps) {
  ...
  const servicesList = [
    ...
    },
    {
      ...
      description: 'Strategic social media campaigns that build communities and drive engagement. We manage \nyour presence across platforms, create compelling content, and grow your audience organically.',
    },
    {
